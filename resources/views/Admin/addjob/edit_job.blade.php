        ...
        <form action="{{route('createjob')}}" method="post">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" value="{{$job->name}}" max-length="190">
                @if($errors->has('name'))
                {{ $errors->first('name') }}
                @endif
              </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="contact" value="{{$job->contact}}" max-length="190">
          ...
          <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="date" class="form-control" name="date" value="{{$job->date}}" max-length="190">
                  @if($errors->has('date'))
                  {{ $errors->first('date') }}
                  @endif
                </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="expectcomplete" value="{{$job->expectcomplete}}" max-length="190">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="datecomplete" value="{{$job->datecomplete}}" max-length="190">
            ...
            <div class="col-md-4">
              ...
              <div class="checkbox">
                ...
                <input class="" name="warranty" type="checkbox" value="{{$job->warranty}}">
              </div>
            ...
            <div class="col-md-4">
              ...
              <div class="checkbox">
               ...
               <input class="" name="calibration" type="checkbox" value="{{$job->calibration}}">
              </div>
            ...
            <div class="col-md-4">
              ...
              <div class="checkbox">
                ...
                <input class="" name="completed" type="checkbox" value="{{$job->completed}}">
              </div>
            ...
            <div class="col-md-4">
              ...
              <div class="checkbox">
                <label class="bmd-label-floating">Invoice</label>
                 <input class="" name="invoiced" type="checkbox" value="{{$job->invoiced}}">
              </div>
            ...
            <div class="col-md-4">
              ...
              <div class="checkbox">
               ...
               <input class="" name="filed" type="checkbox" value="{{$job->filed}}">
              </div>
                @if($errors->has('filed'))
                {{ $errors->first('filed') }}
                @endif
              ...
              <div class="form-group">
                <select class="form-control" name="jobtype_id" id="cars">
                    ...
                    @foreach($jobtype as $type )
                      <option value="{{$job->jobtype->id}}">{{$job->jobtype->name}}</option>
                    @endforeach
                </select>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="enteredby" value="{{$job->enteredby}}" max-length="190">
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="detail" value="{{$job->detail}}" max-length="190">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="action" value="{{$job->action}}" max-length="190">
