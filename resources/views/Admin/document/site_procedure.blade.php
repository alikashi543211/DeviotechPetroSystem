...
@section('page-title', 'Site Procedures')
@section('content')
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-primary">
                <h4 class="card-title">Upload Site Procedure</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('doc.site_procedure.upload') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-danger">
                <h4 class="card-title">Site Procedures</h4>
            </div>
            <div class="card-body">
