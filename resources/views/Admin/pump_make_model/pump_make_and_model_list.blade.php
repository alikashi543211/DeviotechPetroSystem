...
@section('page-title', 'Pump Make List')
@section('content')
...
<div class="row">
  <div class="col-md-12">
    <div class="col-md-12 text-right">
      <button class="btn btn-primary btn-sm bold open-modal" data-update_url="{{ route('pump_list') }}" data-url="{{ route('pump_make_and_model') }}">
    ...
    <div class="card">
      <div class="card-header card-header-primary">
        <h4 class="card-title ">Make Model List</h4>
      </div>
      <div class="card-body">
