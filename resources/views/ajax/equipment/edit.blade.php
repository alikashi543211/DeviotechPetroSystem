<form action="{{route('equipment.save',$equipment->id)}}" method="post">
    @csrf
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select class="form-control select2" name="customer_id" id="a_c_code">
                    ...
                    @if($equipment->customer_id == $cus->id)
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select class="form-control select2" name="pump_make_and_model_id" id="pump_make_and_model_id">
                    ...
                    {{-- @if($equipment->pump_make_and_model_id == $mm->id) --}}
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="start_date" id="start_date"
                    class="form-control datepicker start_date" value="">
                @error('start_date')
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
...
<script type="text/javascript">
    ...
    var data = <?php echo json_encode($equipment) ?>;
