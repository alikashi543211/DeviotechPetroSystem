...
<body>
    ...
    <div>
        ...
        <h2 style="margin-left:2px;font-style: italic;">
            Please find engineer jobcard for {{ date('d/m/Y') }}
        </h2>
        <h2 style="margin-left:2px;font-style: italic;">
            Site Address : {{ $job->customer->address1 ?? '' }} {{ $job->customer->address2 ?? '' }} {{ $job->customer->address3 ?? '' }} {{ $job->customer->address4 ?? '' }}
        </h2>
    </div>
