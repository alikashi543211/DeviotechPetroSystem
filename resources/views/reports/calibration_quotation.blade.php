...
<head>
    ...
    <title>Verification Quotation</title>
...
<main>
                        ...
                        <tbody>
                            @foreach($verify_quotation_items as $item)
                                <tr>
                                    ...
                                    <td>
                                        1 Nozzle @ €{{$item->cost_1st_nozzle}}.00 @if($item->nozzles-1 > 0) and {{$item->nozzles-1}} Nozzle(s) @
                                        €{{$item->cost_other_nozzles}}.00 @endif 
                                    </td>
                            ...
                            <tr class="pump_data">
                                ...
                                <td><b >Total:  €{{$total_amount}}.00</b></td>
                            </tr>
        ...
        <table width="100%">
            <tbody>
                <tr>
                    ...
                    <td width="65%" valign="top" class="note-following">
        ...
        <table width="100%">
            <tbody>
                <tr>
                    ...
                    <td width="12%" valign="top" class="show_underline"></td>
                    <td width="3%">Date:</td>
                    <td width="12%" valign="top" class="show_underline"></td>
                    <td width="72%"></td>
                </tr>
                <tr>
                    <td width="8%"></td>
                    <td width="5%"></td>
                    <td width="30%" valign="top">(On behalf of the Retailer)</td>
                    <td width="3%"></td>
                ...
                <tr>
                    <td width="8%"></td>
                    <td width="5%"></td>
                    <td width="30%" valign="top">Signing indicates acceptance of the above.</td>
                    <td width="3%"></td>
                    <td width="10%" valign="top"></td>
                    <td width="54%"></td>
                </tr>
    ...
    @if($verify_quotation->sign_off==1)
        <table width="100%">
            <tbody>
                <tr>
                    <td width="11%"></td>
                    <td width="78%" class="note-following">
                        <ul>
                            <li class="note-following">P reliminaries, to include for all insurances</li>
                            <li class="note-following">H ealth and safety file, small tools,</li>
                            <li class="note-following">Plant and equipment as necessary</li>
                            <li class="note-following">
                                All work will be undertaken in accordance with the requirements of SI
            ...
            <tbody>
                <tr>
                    ...
                    <td width="78%">
                        <ul>
                            <li class="note-following">
                                In accordance with the safety health and welfare at work regulation 2013
                                S.I.No. 291 of 2013 a PSDP(Project Supervisor Design Process) and a
                                PSCS(Project Supervisor Construction Stage) has to be appointed for this job.
                            </li>
                            <li class="note-following"> 
                                A ll work will be undertaken in accordance with the requirements of SI No 630
    ...
    <table width="100%" class="vat_table">
        <tbody>
            <tr>
                <td width="25%"></td>
                <td width="50%" class="vat_column" class="middle_box">
