...
<body>
    @include('reports.includes.report_header',['title'=>'Job Details'])
            ...
            <tr>
                ...
                <td width="94%" style="text-align: center !important;">
                    <table>
                        <tbody>
                            <tr>
                                <td class="theading">Job No</td><td class="tcolumn">{{$job->id}}</td></td>
                            </tr>
                            <tr>
                                <td class="theading">Date</td><td class="tcolumn">{{dateFormat($job->created_at)}}</td></td>
                            </tr>
                            <tr>
                                <td class="theading">AcCode</td><td class="tcolumn">{{$job->customer->code}}</td></td>
                            </tr>
                            <tr>

                                <td class="theading">Customer</td><td class="tcolumn">{{$job->customer->name}}</td></td>
                            </tr>
                            <tr>
                                <td class="theading">Contact Name</td><td class="tcolumn">{{ $contact_info->forename ?? '' }} {{ $contact_info->surname ?? '' }}</td></td>
                            </tr>
                            <tr>

                                <td class="theading">Actions Taken<td class="tcolumn">{{ $job->action }}</td></td>
                            </tr>
                            <tr>
                                <td class="theading">Job Details<td class="tcolumn">{{ $job->detail }}</td></td>
                            </tr>
                            <tr>
                                <td class="theading">Completed<td class="tcolumn"><input type="checkbox" @if($job->completed) checked @endif></td></td>
                            </tr>
                        </tbody>
                    </table>
                </td>
